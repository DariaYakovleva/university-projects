 ...
 */
public class Database4 extends ContentProvider {
    final String LOG_TAG = "DB";
    static final int DB_VERSION = 1;
    private static final String DB_NAME = "exam.db";
    public static final String TABLE_NAME4 = "exam";
    public static final String TABLE_NAME2 = "genres";
    public static final String TABLE_NAME3 = "playlists";
    public static final String TABLE_NAME = "playtosong";
    ...
    static final String AUTHORITY = "ru.ifmo.md.exam1.providers.exam4";

    static final String CONTACT_PATH = "playtosong";
