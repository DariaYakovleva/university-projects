 ...
 */
public class Database2 extends ContentProvider {
    final String LOG_TAG = "DB";
    static final int DB_VERSION = 1;
    private static final String DB_NAME = "exam.db";
    public static final String TABLE_NAME2 = "exam";
    ...
    public static final String DB_CREATE1 =
    ...
    static final String AUTHORITY = "ru.ifmo.md.exam1.providers.exam2";

    static final String CONTACT_PATH = "genres";
