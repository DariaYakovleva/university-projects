...
//  	add_step(delm, "_", "_", "0", goag, "_", top, "_", top, "0", top);
//  	add_step(delm, "_", "_", "1", goag, "_", top, "_", top, "1", top);
...
//  	add_step(delm2, "_", "_", "0", goag, "_", top, "_", top, "0", l);
//  	add_step(delm2, "_", "_", "1", goag, "_", top, "_", top, "1", l);
//  	add_step(delm2, "_", "_", "_", delm, "_", top, "_", r, "_", r); // ok ? sad
