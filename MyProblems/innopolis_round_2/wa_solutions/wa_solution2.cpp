...
//		cout << teleports2[i].x << "  " << teleports2[i].left << " " << teleports2[i].right << endl;
		...
		int llx2 = (int)(upper_bound(teleports2, teleports2 + n, telep2(0, llx, 0, 0, 0), cmp) - teleports2);
		int rlx2 = (int)(upper_bound(teleports2, teleports2 + n, telep2(0, rlx, 0, 0, 0), cmp) - teleports2) - 1;
