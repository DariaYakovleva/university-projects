...
public class Multiplier implements Expression {
	...
	public Polinom evaluate() {
		...
		if (a.isZero() || b.isZero()) return new Polinom(new ArrayList<Mpair>(), new Const(0));
		...
		p.push(new Summand(a.getExp(), b.getExp()), b.getCnst());
		return p.add((new Multiplier(a, b.rest())).evaluate());
	}
